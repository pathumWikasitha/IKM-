...
def answer_question(question: str, enable_planning: bool = True) -> Dict[str, Any]:
    ...
    Args:
        ...
        enable_planning: Whether to invoke the planning agent or bypass it.

    Returns:
        Dictionary containing at least `answer` and `context` keys.
    """
    return run_qa_flow(question, enable_planning)
